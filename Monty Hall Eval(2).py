...
while True:
    user = input("Who is playing, Bill, Raj, Sahndit, or Simmti ")
    if user.lower() == 'Bill': break
    elif user.lower() == 'Raj': break
    elif user.lower() == 'Sahndit': break
    elif user.lower() == 'Simmti': break
    else:
        print("sorry")
...
PercentStayCorrectLarge = len(StayLarge) / 10000000
PercentSwitchCorrectLarge = len(SwitchLarge) / 10000000
...
#2:07 for one billion


# In[ ]:


#2:05 for  one million - 2:06 - not even one minute
